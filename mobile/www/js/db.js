...
const DB = (function () {
  ...
  const VERSION = 3;
  const STORES = ['categories', 'sources', 'expenses', 'incomes', 'limits', 'alerts', 'recurrences', 'goals', 'meta'];
  let db = null;
  ...
  function open() {
    return new Promise((resolve, reject) => {
      ...
      req.onupgradeneeded = (e) => {
        ...
        for (const name of ['categories', 'sources', 'expenses', 'incomes', 'limits', 'alerts', 'recurrences', 'goals']) {
